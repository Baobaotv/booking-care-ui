                ...
                <div className={cx('wrapper-content')}>
                    <div className={cx('info-doctor-content')}>
                        ...
                        <div className={cx('info-doctor-description')}>
                            <h1 className={cx('info-doctor-title')}>Cập nhật lịch khám</h1>
                ...
                <div className={cx('wrapper-content')}>
                    <div>
                        <label className={cx('info-book-cost')}>
                            ...
                            <span>Giá khám</span>
                            <div>{!!form.current.amount.current && form.current.amount.current.value}</div>
                            <input type={'hidden'} ref={form.current.amount} />
                        </label>
                    </div>
