    ...
    return <div className={cx('wrapper')}>
        <div className={cx('content')}>
            <header className={cx('content-header')}>
                {
                    ...
                    ?
                    <>
                    <FontAwesomeIcon icon={faCircleCheck} className={cx('header-icon', 'header-icon-success')}></FontAwesomeIcon>
                    ...
                    :
                    <>
                    <FontAwesomeIcon icon={faCircleXmark} className={cx('header-icon', 'header-icon-error')}></FontAwesomeIcon>
                ...
                
                {
                    ...
                    <>
                        ...
                        <div className={cx('payment-info-row')}>
                            ...
                            <span className={cx('payment-info-row-valuw')}>{!!paymentResponse ? paymentResponse.vnpTxnRef : ''}</span>
                        </div>
                        <div className={cx('payment-info-row')}>
                            <span className={cx('payment-info-row-title')}>Số tiền thanh toán</span>
                            <span className={cx('payment-info-row-valuw')}>{!!paymentResponse ? paymentResponse.vnpAmount : ''}</span>
                        </div>
                        ...
                        <div className={cx('payment-info-row')}>
                            ...
                            <span className={cx('payment-info-row-valuw')}>{!!paymentResponse ? paymentResponse.vnpBankCode : ''}</span>
                        </div>

                        <div className={cx('payment-info-row')}>
                            <span className={cx('payment-info-row-title')}>Thông tin giao dịch</span>
                            <span className={cx('payment-info-row-valuw')}>{!!paymentResponse ? paymentResponse.vnpOrderInfo : ''}</span>
                        </div>

                        <div className={cx('payment-info-row')}>
                            <span className={cx('payment-info-row-title')}>Ngày khám bệnh</span>
                            <span className={cx('payment-info-row-valuw')}>{!!paymentResponse ? paymentResponse.medicalExaminationSchedule.date : ''}</span>
                        </div>
            ...
            <div className={cx('payment-redirect')}>
                <Link to ={config.routes.home} className={cx('payment-btn')}>{'Trở về trang chủ'}</Link>
            </div>
        </div>
    </div>;
}
